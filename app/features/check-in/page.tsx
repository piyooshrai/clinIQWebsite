...
const painPoints = [
  ...
  {
    heading: 'No confirmation the patient is actually here',
    body: 'A scheduled appointment doesn\'t mean the patient arrived. Without check-in, you\'re just guessing.',
  },
];
